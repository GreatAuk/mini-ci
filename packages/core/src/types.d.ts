...
export type BumpOptionsInput = VersionBumpOptions | ((ctx: BumpOptionsContext) => VersionBumpOptions | Promise<VersionBumpOptions>);
/** 支持的 CLI 操作列表 */
export declare const supportedOperations: readonly ["open", "preview", "upload"];
/** 支持的 uniapp 小程序平台列表 */
export declare const supportedPlatforms: readonly ["mp-weixin", "mp-alipay", "mp-baidu", "mp-jd", "mp-toutiao"];
/** CLI 操作类型 */
...
/** 支付宝小程序上传终端类型 */
export type AlipayClientType = "alipay" | "ampe" | "amap" | "genie" | "alios" | "uc" | "quark" | "koubei" | "alipayiot" | "cainiao" | "alihealth" | "health";
/** 支付宝小程序 CI 配置 */
