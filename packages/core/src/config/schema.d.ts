...
export declare const miniciConfigSchema: z.ZodObject<
  {
    ...
    desc: z.ZodOptional<
      z.ZodUnion<readonly [z.ZodString, z.ZodCustom<MiniCIDescFunction, MiniCIDescFunction>]>
    >;
    projectPath: z.ZodOptional<z.ZodString>;
    qrcodePath: z.ZodOptional<
      z.ZodObject<
        {
    ...
    "mp-jd": z.ZodOptional<
      ...
      >
    >;
    "mp-toutiao": z.ZodOptional<
      z.ZodObject<
        {
          email: z.ZodString;
          password: z.ZodString;
          setting: z.ZodOptional<
            z.ZodObject<
              {
 ...
 * @returns 指定平台的私有配置
 */
export declare function validatePlatformConfig<P extends MiniCIPlatform>(
  platform: P,
  config: unknown,
): PlatformConfigMap[P];
/**
